 ...
 * In this work I learned about object-oriented programming,
 * and about implementation of interface.
 * implement a set of geometric shapes, a shape container,
 * a basic GUI, and basic save/load capabilities
 * The following algorithm is divided into several classes where each
 * class represents a different shape - triangle, rectangle, circle, and polygon.
 * In each shape, I implemented the functions required to draw shapes,
 * delete, add, and a number of other functions that we use in the shapeCollection.
 *
 *
...
public class Ex2 implements Ex2_GUI {
    ...
    public void actionPerformed(String p) {
        ...
        if (p.equals("ByToAntiString")) {
            _shapes.sort(ShapeComp.CompByToString.reversed());
        }
        ...
        if (p.equals("ByAntiTag")) {
            _shapes.sort(ShapeComp.CompByTag.reversed());
        }
        //////////////////////////////
